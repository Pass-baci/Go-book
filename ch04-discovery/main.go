...
import (
	...
	"Go-/ch04-discovery/endpoint"
	"Go-/ch04-discovery/service"
	"Go-/ch04-discovery/transport"
	"context"
	"flag"
	"fmt"
...
func main() {
	...
	discoveryClient, err := discover.NewKitDiscoveryClient(*consulHost, *consulPort)
	// 获取服务发现客户端失败，直接关闭服务
	if err != nil {
